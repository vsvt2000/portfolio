  ...
  return (
    <div>
      ...
      <div className="h-screen w-full px-4 pt-32">
        <div className="mx-auto w-full max-w-lg divide-y divide-white/5 rounded-xl bg-green-800">
                {FAQs.map((pair,index)=>
          ...
          <Disclosure key={index}  as="div" className="p-6">
            ...
            <DisclosurePanel className="font-semibold italic mt-2 text-sm/5 text-white/80">
              {pair.answer}
            </DisclosurePanel>
          </Disclosure>
                  )}
